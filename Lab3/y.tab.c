...
{
       0,    40,    40,    50,    60,    66,    74,    86,   100,   109,
     117,   124,   132,   143,   151,   160,   164,   168,   173,   182,
     193,   200,   209,   214,   220,   232,   238,   244,   250,   264,
     274,   285,   295,   305,   315,   319,   328,   332,   343,   348,
     358,   362,   372,   376,   386,   392,   402,   406,   416,   423,
     429,   436,   440,   449,   457,   461,   465,   472,   481,   486,
     492,   500
};
#endif
...
#line 51 "21141009.y"
    {
		...
		(yyval) = new symbol_info("program","non-terminal",node);
		rootNode = node;    
...
#line 61 "21141009.y"
    {
		...
		node -> addChild((yyvsp[(1) - (1)])->getNode());
		(yyval) = new symbol_info("unit","non-terminal",node);
	 }
    break;
...
#line 87 "21141009.y"
    {
			...
			(yyval) = new symbol_info("func_definition","non-terminal",node);
...
#line 101 "21141009.y"
    {
			...
			(yyval) = new symbol_info("parameter_list","non-terminal",node);
		}
    break;
...
#line 133 "21141009.y"
    { 
			...
			//outlog << "/n" <<std::endl<<std::endl;
			(yyval) = new symbol_info("compound_statement","non-terminal",node);
		}
    break;
...
#line 152 "21141009.y"
    {
			...
			(yyval) = new symbol_info("var_declaration","non-terminal",node);
		}
    break;
...
#line 174 "21141009.y"
    {
			...
			node -> addChild(TreeNode::createTerminalNode("COMMA",","));
			node -> addChild((yyvsp[(3) - (3)])->getNode());
			(yyval) = new symbol_info("declaration_list","non-terminal",node);
...
#line 201 "21141009.y"
    {
			...
			node -> addChild(TreeNode::createTerminalNode("const_int", (yyvsp[(1) - (4)])->getname().c_str()));
...
#line 215 "21141009.y"
    {
			...
			node -> addChild((yyvsp[(1) - (1)])->getNode());
			(yyval) = new symbol_info("statements","non-terminal",node);
		}
    break;
...
#line 233 "21141009.y"
    {
			TreeNode* node = TreeNode::createNonTerminalNode("statements");
			node -> addChild((yyvsp[(1) - (1)])->getNode());
			(yyval) = new symbol_info("statement","non-terminal",node); 	
	  }
    break;
...
#line 265 "21141009.y"
    {
			...
			node -> addChild(TreeNode::createTerminalNode("RPAREN",")"));
			node -> addChild((yyvsp[(5) - (5)])->getNode()); //CHECK !!!
			(yyval) = new symbol_info("statement","non-terminal",node);
	  }
    break;
...
#line 275 "21141009.y"
    {
			...
			node -> addChild((yyvsp[(6) - (7)])->getNode()); 
			(yyval) = new symbol_info("statement","non-terminal",node);
	  }
    break;
...
#line 320 "21141009.y"
    {
				...
				node -> addChild((yyvsp[(1) - (2)])->getNode());
				node -> addChild(TreeNode::createTerminalNode("SEMICOLON",";"));
				(yyval) = new symbol_info("expression_statement","non-terminal",node);	
	        }
    break;
...
#line 333 "21141009.y"
    {
			...
			node -> addChild((yyvsp[(3) - (4)])->getNode());
			node -> addChild(TreeNode::createTerminalNode("RTHIRD","]")); 
			(yyval) = new symbol_info("variable","non-terminal",node);	
	 }
    break;
...
#line 349 "21141009.y"
    {
			...
			node -> addChild((yyvsp[(3) - (3)])->getNode());
			(yyval) = new symbol_info("expression","non-terminal",node); 	
	   }
    break;
...
#line 363 "21141009.y"
    {
			...
			node -> addChild((yyvsp[(3) - (3)])->getNode());
			(yyval) = new symbol_info("logic_expression","non-terminal",node); 	
	     }
    break;
...
#line 377 "21141009.y"
    {
			...
			node -> addChild((yyvsp[(3) - (3)])->getNode());
			(yyval) = new symbol_info("rel_expression","non-terminal",node); 	
	    }
    break;
...
#line 441 "21141009.y"
    {
		...
		node -> addChild((yyvsp[(3) - (4)])->getNode());
		node->addChild(TreeNode::createTerminalNode("RPAREN", ")"));
		(yyval) = new symbol_info("unary_expression", "for", node);   
	}
    break;
...
#line 450 "21141009.y"
    {
		...
		node -> addChild((yyvsp[(2) - (3)])->getNode());
		node->addChild(TreeNode::createTerminalNode("RPAREN", ")"));
		(yyval) = new symbol_info("factor", "for", node);     
	}
    break;
...
int main(int argc, char *argv[])
{
    ...
    yyin = fopen(argv[1], "r");
    outlog.open("21141009.txt", std::ios::trunc);
